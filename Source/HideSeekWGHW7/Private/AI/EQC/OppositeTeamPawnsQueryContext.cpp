...
#include "AI/EQC/OppositeTeamPawnsQueryContext.h"
#include "Components/HSTeamComponent.h"
#include "EnvironmentQuery/EnvQueryTypes.h"
#include "EnvironmentQuery/Items/EnvQueryItemType_Actor.h"

void UOppositeTeamPawnsQueryContext::ProvideContext(FEnvQueryInstance& QueryInstance, FEnvQueryContextData& ContextData) const
{
