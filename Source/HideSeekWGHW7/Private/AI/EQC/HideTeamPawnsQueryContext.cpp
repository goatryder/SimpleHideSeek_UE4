...
void UHideTeamPawnsQueryContext::ProvideContext(FEnvQueryInstance& QueryInstance, FEnvQueryContextData& ContextData) const
{
	...
	if (QueryActor)
	{
		...
		if (TeamComp)
		{
			...
			TArray<UHSTeamComponent*> TeamComps = UHSTeamComponent::GetTeamComponents(ETeamType::Hide);
